...
// Budget is set per trip, so it is not treated as a persistent travel-profile preference.
...
export const exploreFallbackTrips = [
  ...
  { id: 'fallback-bangkok-hua-hin', author_name: 'Sofia · Exchange student', title: 'Bangkok to Hua Hin on a student budget', start: 'Bangkok, Thailand', destination: 'Hua Hin, Thailand', route_mode: 'balanced', adventure_level: 61, budget_per_person: 88, travellers: 4, preferences: ['local-gems'], route: { distance_km: 200, drive_minutes: 165 }, itinerary: [{ title: 'Floating market breakfast', kind: 'meal' }, { title: 'Phetchaburi viewpoint', kind: 'attraction' }, { title: 'Beachside dinner', kind: 'meal' }], is_public: true, is_completed: true, media: [] },
